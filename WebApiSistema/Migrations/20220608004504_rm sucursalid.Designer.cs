...
namespace WebApiSistema.Migrations
{
    ...
    [Migration("20220608004504_rm sucursalid")]
    partial class rmsucursalid
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApiSistema.Models.Alquiler.Alquiler", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApiSistema.Models.Alquiler.AlquilerDetalle", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApiSistema.Models.Salida.Salida", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApiSistema.Models.Salida.SalidaDetalle", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApiSistema.Models.Alquiler.AlquilerDetalle", b =>
                {
                    b.HasOne("WebApiSistema.Models.Alquiler.Alquiler", "Alquiler")
                        .WithMany("Detalles")
            ...
            modelBuilder.Entity("WebApiSistema.Models.Salida.SalidaDetalle", b =>
                {
                    ...
                    b.HasOne("WebApiSistema.Models.Salida.Salida", "Salida")
                        .WithMany()

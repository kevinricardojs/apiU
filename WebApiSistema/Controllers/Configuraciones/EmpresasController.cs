...
using WebApiSistema.DTO.Configuraciones.Empresa;
...
namespace WebApiSistema.Controllers.Configuraciones
{
    ...
    public class EmpresasController : MainController
    {
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Empresa>> PostEmpresa(EmpresaCreate empresa)
        {
            ...
            return CreatedAtAction("GetEmpresa", new { id = e.ID }, e);
        }
